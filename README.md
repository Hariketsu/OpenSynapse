...
| --- | --- | --- |
| Windows policies | Adapter-aware Auto, Hyper, Balance, Eco, and locked Experiment selection; power plans; refresh rate; Advanced Color/HDR; per-display brightness; display scaling; optional wake-device control | 2.5.1 lock/suspend-safe wake recovery installed and runtime-validated |
