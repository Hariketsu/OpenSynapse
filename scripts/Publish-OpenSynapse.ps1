...
$zipPath = [IO.Path]::GetFullPath((Join-Path $artifacts 'OpenSynapse-2.5.0.zip'))
...
Write-Host "OpenSynapse 2.5.0 package: $output"
Write-Host "OpenSynapse 2.5.0 archive: $zipPath"
