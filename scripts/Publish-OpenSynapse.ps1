...
$zipPath = [IO.Path]::GetFullPath((Join-Path $artifacts 'OpenSynapse-2.4.1.zip'))
...
Write-Host "OpenSynapse 2.4.1 package: $output"
Write-Host "OpenSynapse 2.4.1 archive: $zipPath"
