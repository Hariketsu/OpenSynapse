...
$zipPath = [IO.Path]::GetFullPath((Join-Path $artifacts 'OpenSynapse-2.5.2.zip'))
...
Write-Host "OpenSynapse 2.5.2 package: $output"
Write-Host "OpenSynapse 2.5.2 archive: $zipPath"
