...
$zipPath = [IO.Path]::GetFullPath((Join-Path $artifacts 'OpenSynapse-2.5.1.zip'))
...
Write-Host "OpenSynapse 2.5.1 package: $output"
Write-Host "OpenSynapse 2.5.1 archive: $zipPath"
