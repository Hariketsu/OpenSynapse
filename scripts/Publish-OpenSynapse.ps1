...
$zipPath = [IO.Path]::GetFullPath((Join-Path $artifacts 'OpenSynapse-2.4.2.zip'))
...
Write-Host "OpenSynapse 2.4.2 package: $output"
Write-Host "OpenSynapse 2.4.2 archive: $zipPath"
