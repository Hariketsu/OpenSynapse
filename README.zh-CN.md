...
| 领域 | 当前能力 | 成熟度 |
| --- | --- | --- |
| Windows 策略 | Smart Auto、Hyper、Balance、Eco 与锁定式 Experiment；电源方案、仅内屏 Windows DRR/固定刷新率、Advanced Color/HDR、逐屏亮度和显示缩放 | 2.5.3 Windows CCD 动态刷新控制已测试 |
